...
int main() {
    ...
    // shaders
    Shader shader("../shaders/HDR_Bloom/lighting.vs",
                  "../shaders/HDR_Bloom/lighting.fs");
    Shader hdrShader("../shaders/HDR_Bloom/hdr.vs",
                     "../shaders/HDR_Bloom/hdr.fs");
...
void processInput(GLFWwindow *window) {
    ...
    if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS && !hdrPressed) // space: toggle HDR
    {
        hdr = !hdr;
        hdrPressed = true;
    }
