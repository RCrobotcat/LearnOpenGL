...
void main()
{
    ...
    // ----------------------------------------------------------------------------
    // calculate reflectance at normal incidence (Not IBL);
...
- `cubemap.vs`, `equirectangular_to_cubemap.fs`
...
void main()
{
    ...
    // HDR tonemap(Reinhard) and gamma correction
...
int main() {
    ...
    float *data = stbi_loadf("../Notes/23_IBL/newport_loft.hdr", &width, &height,
                             &nrComponents, 0);
