...
GLboolean shadowsKeyPressed = false;
...
int main()
{
    ...
    Shader shader("../shaders/ShadowMapping/PointShadows/pointShadow.vs",
                  "../shaders/ShadowMapping/PointShadows/pointShadow.fs");
    Shader simpleDepthShader("../shaders/ShadowMapping/PointShadows/point_shadows_depth.vs",
                             "../shaders/ShadowMapping/PointShadows/point_shadows_depth.gs",
                             "../shaders/ShadowMapping/PointShadows/point_shadows_depth.fs");

    woodTexture = loadTexture("../Notes/16_BlinnPhong_GammaCorrection/BlinnPhong/wood.png", false);
...
void renderScene(const Shader &shader)
{
    ...
    renderCube();
    model = glm::mat4(1.0f);
    model = glm::translate(model, glm::vec3(-2.0f, 1.0f, 1.5));
    shader.setMat4("model", model);
    renderCube();
    model = glm::mat4(1.0f);
