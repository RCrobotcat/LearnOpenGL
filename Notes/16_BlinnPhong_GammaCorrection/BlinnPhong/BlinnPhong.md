...
int main()
{
    ...
    Shader shader("../shaders/Advanced_Lighting/blinnphong.vs",
                  "../shaders/Advanced_Lighting/blinnphong.fs");
    ...
    // load textures
    // -------------
    unsigned int floorTexture = loadTexture("../Notes/16_BlinnPhong_GammaCorrection/BlinnPhong/wood.png");
