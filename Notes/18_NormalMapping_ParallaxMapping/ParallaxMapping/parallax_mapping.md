...
int main()
{
    ...
    unsigned int diffuseMap = loadTexture("../Notes/18_NormalMapping_ParallaxMapping/ParallaxMapping/bricks2.jpg");
    unsigned int normalMap =
            loadTexture("../Notes/18_NormalMapping_ParallaxMapping/ParallaxMapping/bricks2_normal.jpg");
    unsigned int heightMap = loadTexture("../Notes/18_NormalMapping_ParallaxMapping/ParallaxMapping/bricks2_disp.jpg");
