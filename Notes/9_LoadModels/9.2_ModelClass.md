...
void Model::loadModel(std::string path)
{
    ...
    // aiProcess_Triangulate 告诉Assimp模型如果不是（全部）由三角形组成，它需要将模型所有的图元形状变换为三角形
    // aiProcess_FlipUVs 是因为OpenGL中大部分的图像的y轴都是反的
    ...
    std::cout << "Model loaded. Meshes: " << scene->mNumMeshes << ", Materials: " << scene->mNumMaterials << std::endl;
